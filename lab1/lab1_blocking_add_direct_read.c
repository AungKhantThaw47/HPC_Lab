...
// Blocking version with direct file reading by each process
...
int main(int argc, char** argv) {
    ...
    // Gather results back to root using blocking Gatherv
    ...
    if (rank == 0) {
        printf("\n=== TOTAL EXECUTION TIME (Blocking Direct Read): %.6f seconds ===\n\n", elapsed_time);
    }
